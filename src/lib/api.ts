...
export const authApi = {
    ...
    getSession: async () => {
        return apiCall<{ user: any; session: any } | null>('/api/auth/get-session', {
            method: 'GET',
        });
    },
};
...
export const studentsApi = {
    ...
    create: async (data: { name: string; class: string; nis?: string; parentId?: string }) => {
        return apiCall<any>('/api/students', {
            method: 'POST',
            body: JSON.stringify(data),
        });
    ...
    update: async (id: string, data: { name?: string; class?: string; nis?: string; isActive?: boolean }) => {
        return apiCall<any>(`/api/students/${id}`, {
            method: 'PUT',
            body: JSON.stringify(data),
        });
...
export const ordersApi = {
    list: async (params?: { status?: string; studentId?: string; partnerId?: string }) => {
...
export const partnersApi = {
    ...
    create: async (data: { name: string; phone?: string; address?: string; userId?: string }) => {
    ...
    update: async (id: string, data: { name?: string; phone?: string; address?: string; isActive?: boolean }) => {
        return apiCall<any>(`/api/partners/${id}`, {
            method: 'PUT',
            body: JSON.stringify(data),
        });
...
export const pricesApi = {
    ...
    update: async (category: string, data: { pricePerUnit: number; unitName?: string }) => {
        return apiCall<any>(`/api/prices/${category}`, {
            method: 'PUT',
            body: JSON.stringify(data),
        });
