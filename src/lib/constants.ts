...
export const ORDER_STATUS = {
  ...
  MENUNGGU_APPROVAL_MITRA: { label: 'Menunggu Approval Mitra', color: 'status-pending' },
  DITOLAK_MITRA: { label: 'Ditolak Mitra', color: 'status-rejected' },
  DISETUJUI_MITRA: { label: 'Disetujui Mitra', color: 'status-approved' },
  MENUNGGU_PEMBAYARAN: { label: 'Menunggu Pembayaran', color: 'status-pending' },
...
export const calculateAdminFee = (baseAmount: number, paymentMethod?: string): number => {
